...
export function App() {
  ...
  return (
    <div className={styles['container']}>
      ...
      <button className={styles['open-dialog-button']} onClick={() => setIsDialogSettingsOpen(true)} aria-label='Open settings'>
      ...
      <SettingsDialog isOpen={isDialogSettingsOpen} onClose={() => setIsDialogSettingsOpen(false)}></SettingsDialog>
    </div>
  )
}
